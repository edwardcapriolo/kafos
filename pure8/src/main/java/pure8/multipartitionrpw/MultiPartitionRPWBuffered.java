...
public class MultiPartitionRPWBuffered<K,V> implements  Runnable {
	...
	protected final BufferedMessageProcessor<K,V> processor;
	protected final ProducerCreator<K,V> producerCreator;
	protected final ConsumerCreator<K,V> consumerCreator;
	
	protected KafkaConsumer<K, V> consumer;
	
	public MultiPartitionRPWBuffered(String groupId, String inputTopic, String bootstrap,
			BufferedMessageProcessor<K,V> processor,
	...
	public static void main(String []args) {
		...
		BufferedMessageProcessor<String,String> mp = new BufferedMessageProcessor<String,String>() {
		...
		MultiPartitionRPWBuffered<String,String> r = new MultiPartitionRPWBuffered<String,String> (split[0], split[1], split[2], 
